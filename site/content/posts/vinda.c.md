...
+++
> Source: [builder.dontvacuum.me](https://builder.dontvacuum.me/vinda/vinda.c)
      ...
      if (iVar5 < 0x18) {
        do {
          if (((int)uVar6 >> iVar5 & 1U) == 0) {
            uVar6 = uVar6 | 1 << iVar5;
            num = num + (uint)*pbVar8 + (uint)(byte)serial[iVar5 + 0x24];
            goto LAB_00012892;
          }
          iVar5 = iVar5 + 1;
        } while (iVar5 != 0x18);
LAB_000128f6:
      ...
      iVar10 = iVar5 + -0x18;
LAB_00012904:
      num = num + (uint)*pbVar8 + (uint)(byte)serial[iVar10];
LAB_00012892:
      iVar3 = iVar3 + -1;
      pbVar9 = pbVar8 + -1;
