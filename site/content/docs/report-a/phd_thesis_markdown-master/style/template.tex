...
\def\largeboldcoverpagefont{\fontfamily{phv}\fontseries{b}\fontsize{22pt}{32pt}\selectfont}
\def\largeslantedcoverpagefont{\fontfamily{phv}\fontshape{sl}\fontsize{22pt}{32pt}\selectfont}
	...
	\begin{center}
            \coverpagefont
            \includegraphics{unsw/crest}
	    \vskip 0pt plus 8fill
	    {\boldcoverpagefont School of Computer Science and Engineering\par}
	    {\boldcoverpagefont Faculty of Engineering\par}
	    {\boldcoverpagefont The University of New South Wales\par}
	    \vskip 0pt plus 8fill
	    {\largeboldcoverpagefont Requirements to theses submitted in \par}
	    {\largeboldcoverpagefont the Faculty of Engineering \par}
	    \vskip 0pt plus 5fill
            by
	    \vskip 0pt plus 4fill
	    {\largecoverpagefont Andrew Jin-Meng Wong \par}
	    ...
	    \vskip 0pt plus 12fill
            \begin{tabular}{@{}rl}
              Submitted: & December 2021 \vrule width 0pt depth 10pt\\
              Supervisor: & Prof.\ Richard Buckland
            \end{tabular}
            \hfill
            \begin{tabular}{rl@{}}
              Student ID: & z5206677 \vrule width 0pt depth 10pt\\
